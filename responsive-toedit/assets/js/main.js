...
sr.reveal(`.home__title, .popular__container, .subscribe__container, .footer__container, .vision__container`)
sr.reveal(`.home__description, .vision__des, .footer__info`, { delay: 500 });
sr.reveal(`.home__search`, {delay: 600})
sr.reveal(`.home__value`, {delay: 700})
sr.reveal(`.home__images`, {delay: 800, origin: 'bottom'})
sr.reveal(`.logos__img`, {interval: 100})
sr.reveal(`.value__images, .vision__images, .contact__content`, {
  origin: "left",
});
